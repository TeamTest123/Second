...
public abstract class BaseServlet extends HttpServlet {
	...
	//以json输出map
		...
		public void printJson(HttpServletResponse response,int i,String msg) throws Exception{
			Map<String, Object> map=new HashMap<>();
			map.put("code", i);
			map.put("msg", msg);
			Gson gson=new Gson();
			String infos=gson.toJson(map);
	...
	//以json格式输出内容
		public void printJson(Object obj,HttpServletResponse response) throws IOException {
			Gson gson=new Gson();
			String infos=gson.toJson(obj);
			PrintWriter out=response.getWriter();
			out.print(infos);
		}
